...
enum AdjustKey: String {
    case AdjustKeyAppToken = "l9sozllqesxs"
    case AdjustKeyAppLaunch = "plk1s7"
    case AdjustKeyAppCoinsBuy = "m68423"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var mainVC: WallQRMainVC = WallQRMainVC()
...
//        com.Moncreation.FancyiIns
        
//        NotificationCenter.default.post(name: .Pre,
//                                        object: [
//                                            HightLigtingHelper.default.debugBundleIdentifier = "com.Moncreation.FancyiIns",
