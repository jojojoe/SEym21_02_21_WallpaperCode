...
import UIKit
import DeviceKit
class EXploreNowEditShapeVC: UIViewController {
...
extension EXploreNowEditShapeVC {
    func loadData() {
        dataList = WQDataM.default.shapeItemList
...
//
    ...
    func setupDefaultImgs() {
        ...
        shapeImgV.image = UIImage(named: currentSelectItem?.bigName ?? "")
...
extension EXploreNowEditShapeVC {
    ...
    @objc func nextBtnClick(sender: UIButton) {
        ...
        let stickerVC = EXploreNowEditStickerVC(image: userImgV.image, shapeImg: shapeImgV.image, isPro: isPro)
    ...
    @objc func randomBtnClick(sender: UIButton) {
        ...
        if let item = dataList.randomElement() {
            shapeImgV.image = UIImage(named: item.bigName)
...
extension EXploreNowEditShapeVC: UICollectionViewDataSource {
...
extension EXploreNowEditShapeVC: UICollectionViewDelegateFlowLayout {
...
extension EXploreNowEditShapeVC: UICollectionViewDelegate {
...
class EXEditToolCollectionCell: UICollectionViewCell {
    ...
    func setupView() {
        ...
        //
        selectBgImgV.image = UIImage(named: "edit_select")
